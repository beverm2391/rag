...
@pytest.mark.external
def test_chat_anthropic(example_args, example_prompts):
    example_prompt_1, example_prompt_2 = example_prompts
...
@pytest.mark.external
def test_chat_cohere(example_args, example_prompts):
    example_prompt_1, example_prompt_2 = example_prompts
...
@pytest.mark.external
def test_chat_openai_stream(example_args, example_prompts):
...
@pytest.mark.external
def test_chat_anthropic_stream(example_args, example_prompts):
    chat = Chat.create("claude-3-haiku", *example_args)
    res = chat.chat_stream(example_prompts[0])
    validate_stream(res)
...
@pytest.mark.external
def test_chat_cohere_stream(example_args, example_prompts):
